...
export default function HomeScreen({ route, navigation }: Props) {
  ...
  return (
    <View style={styles.container}>
      <Image style={styles.imagem} source={require('../assets/images/logoIcon.png')}/>
      <Text style={styles.title}>Bem-vindo ao Athenas Bank</Text>
      <Text style={styles.saldo}>Seu saldo é: R$ 25.000,00</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: 'bold', marginBottom: 15, alignSelf: 'center', color: '#353E67' },
  saldo: { fontSize: 20, marginBottom: 20, alignSelf: 'center', color: '#353E67'},
  token: { fontWeight: 'bold' },
  tokenValue: { fontSize: 12, color: 'gray'},
  buttonWrapper: { marginBottom: 15},
  imagem: { padding: 20, width: 150, height: 150, alignSelf: 'center', marginBottom: 20}
})
